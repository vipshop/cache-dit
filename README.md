...
- 🎉**Hybrid [2D/3D/5D](https://cache-dit.readthedocs.io/en/latest/user_guide/HYBRID_PARALLEL/) Parallelism** ([**USP+TP**](https://cache-dit.readthedocs.io/en/latest/user_guide/HYBRID_PARALLEL/)+..., Scale up the speed of **Large DiTs**!)
