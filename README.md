...
- [2025-09-24] 🔥**cache-dit** has now joined the 🤗 Diffusers community ecosystem! Check out the documentation here: [Diffusers Docs](https://huggingface.co/docs/diffusers/main/en/optimization/cache_dit). We encourage you to give it a try. 
