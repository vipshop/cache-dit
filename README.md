...
> [!NOTE]
> Please note that Quantization and Offload in Cache-DiT are generally supported for **nn.Module**, no special integration is needed for new DiT pipelines. Once the new DiT pipeline is integrated into Cache-DiT, it will automatically support Quantization and Offload.
