...
## 🔥News🔥
- [2025-07-18] 🎉First caching mechanism in official **[🤗huggingface/flux-fast](https://github.com/huggingface/flux-fast)** with **[cache-dit](https://github.com/vipshop/cache-dit)**, please check this [PR](https://github.com/huggingface/flux-fast/pull/13). 
