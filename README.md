<div align="center">
  ...
  <p align="center">
    DeepCache is for UNet, but DiT has no U-shape so it can't use it. Most DiT cache speedups are complex and not training-free. DBCache fixes this: builds on FBCache to make a UNet-style, Training-free Cache Acceleration for DiT.
  </p>
</div>
