<div align="center">
  ...
  <p align="center">
    DeepCache requires UNet’s U-shape, but DiT lacks it. Most DiT cache accelerators are complex <br>and not training-free. CacheDiT provides a series training-free, UNet-style cache accelerators for DiT, <br>such as DBCache, DBPrune, FBCache, AlterCache, etc.
  </p>
</div>
