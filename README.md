...
## 🔥News🔥
- [2025-07-18] 🎉First caching mechanism in **[🤗huggingface/flux-fast](https://github.com/huggingface/flux-fast)** with **[cache-dit](https://github.com/vipshop/cache-dit)**. Check out the accompanying **[PR](https://github.com/huggingface/flux-fast/pull/13)**. 
