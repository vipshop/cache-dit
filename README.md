...
| **[DBCache + TaylorSeer (F=4,B=0,O1)](https://github.com/vipshop/cache-dit)** | **1388.30** | **2.68×** | **1.0287** | **32.914** |
| DuCa (N=5) | 978.76 | 3.80× | 0.9955 | 32.241 |
| TaylorSeer (N=4, O=2) | 1042.27 | 3.57× | 0.9857 | 32.413 |
| **[DBCache + TaylorSeer (F=1,B=0,O1)](https://github.com/vipshop/cache-dit)** | **1153.05** | **3.23×** | **1.0221** | **32.819** |
