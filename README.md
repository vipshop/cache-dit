...
- **[🎉Full 🤗Diffusers Support](./docs/User_Guide.md#supported-pipelines)**: Notably, **cache-dit** now supports nearly **all** of Diffusers' **DiTs**, include **[60+](./examples/)** models: 🔥FLUX, 🔥Qwen-Image, 🔥Z-image, 🔥LongCat-Image, 🔥Wan, etc.  
...
| 📚Supported DiTs: `🤗60+` | Cache  | Context | Tensor | Text | CN |
|:---:|:---:|:---:|:---:|:---:|:---:|
