<div align="center">
  <p align="center">
    <h3>🤗CacheDiT: An easy-to-use and Training-free Cache Acceleration <br>Toolbox for Diffusion Transformers</h3>
  </p>
  ...
  <p align="center">
    DeepCache requires UNet’s U-shape, but DiT lacks it. Most DiT cache accelerators are complex and not training-free. CacheDiT provides a series training-free, UNet-style cache accelerators for DiT, such as DBCache, DBPrune, FBCache, etc.
  </p>
</div>
...
```BibTeX
@misc{CacheDiT@2025,
  title={CacheDiT: An easy-to-use and training-free cache acceleration Toolbox for Diffusion Transformers},
