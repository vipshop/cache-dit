...
DBCache is configured by default with F8B8, warmup_steps=8, and unlimited cached steps (max_cached_steps=-1) for a good balance between performance and precision.
