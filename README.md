...
Cache-DiT provides a [new-model-integration](./.copilot/skills/cache-dit-model-integration/SKILL.md) SKILL to help users easily integrate new DiT pipelines into Cache-DiT, including **Cache, CP, TP, TE-P, VAE-P** and carefully designed test cases. Users can use it with Coding Agents, e.g, [GitHub Copilot](https://docs.github.com/en/copilot), [Claude Code](https://claude.ai), [Open Code](https://opencode.ai/). 
