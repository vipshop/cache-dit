...
|:---|:---|:---| 
|<span style="color:#c77dff;">float8_per_row</span>, recommended|quantize weights and activations to float8 (dynamic quantization) with rowwise method.|<span style="color:#c77dff;">>=sm89</span>, Ada, Hopper or newer|
