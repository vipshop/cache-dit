...
Please note that we have alreay support <span style="color:hotpink;">Hybrid Parallelism (CP/USP + TP)</span> for 💥**Large DiT's** transformer module. Please refer to [Hybrid 2D and 3D Parallelism](./HYBRID_PARALLEL.md) for more details.
