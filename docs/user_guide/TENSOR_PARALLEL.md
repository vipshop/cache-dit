...
Please note that we have alreay support Hybrid Parallelism (CP/USP + TP) for 💥**Large DiT's** transformer module. Please refer to [Hybrid 2D and 3D Parallelism](./HYBRID_PARALLEL.md) for more details.
