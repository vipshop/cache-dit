...
<span style="color:#c77dff;">Flash Attention 3</span> provides optimized attention kernels for better performance. To install:
...
Find `_diffusers_flash_attn_3::_flash_attn_forward` and add <span style="color:#c77dff;">return_attn_probs=True</span>:
...
- <span style="color:#c77dff;">Clear</span> the torch inductor <span style="color:#c77dff;">cache:</span>
...
- <span style="color:#c77dff;">Upgrade</span> PyTorch to the latest version:
...
- **H100/H200**: Use <span style="color:#c77dff;">_flash_3</span> for best performance
- **A100/A6000**: Use <span style="color:#c77dff;">flash</span> or <span style="color:#c77dff;">sage</span>
- **Other GPUs**: Use <span style="color:#c77dff;">native</span> or <span style="color:#c77dff;">sage</span>
