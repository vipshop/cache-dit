import os
from ..logger import init_logger, suppress_torch_compile_loggers, globally_suppress_loggers
...
def entrypoint():
    ...
    if args.task == "list":
        ...
        if os.environ.get("CACHE_DIT_ENABLE_LOGGERS_SUPPRESS", None) is None:
