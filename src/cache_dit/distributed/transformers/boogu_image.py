...
try:
  from fast_boogu.pipelines.boogu.models.attention_processor import (
    Attention,
...
def _patch_dtensor_unsafe_modules(block: nn.Module) -> None:
  ...
  try:
    from fast_boogu.pipelines.boogu.ops.triton.layer_norm import RMSNorm as TritonRMSNorm
...
def _patch_attention_processor_for_cp(transformer: nn.Module) -> None:
  ...
  def _patched_sdpa_call(
    ...
    from fast_boogu.pipelines.boogu.models.embeddings import apply_rotary_emb as _boogu_apply_rotary_emb
